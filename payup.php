...
<!-- Payment QR code -->
 <div id="about" class="container g-padding-y-60--xs g-padding-y-80--sm">
            <div class="g-text-center--xs g-margin-b-20--xs">
                <p class="text-uppercase g-font-size-20--xs g-font-weight--700 g-letter-spacing--2 g-margin-b-25--xs" style="color: #0079bf">Pay Using QR-Code</p>
            </div>
            ...
            <br>
             <div class="col-sm-3" ></div>
                <div class="col-sm-5 col-sm-pull-4 g-hor-centered-row__col g-text-left--xs g-text-right--md" style="padding-top: 30%;">
                    <!--<h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">About StartUp Conclave</h2>-->
                    <p class="g-font-size-18--sm">You will recieve a payment confirmation email within 6 hours of your payment.</p>
                </div>
            </div>
        </div>
        <!-- End qr-code -->
        ...
        <div id="about" class="container g-padding-y-60--xs g-padding-y-80--sm">
            ...
            <div class="row g-hor-centered-row--md g-row-col--5">
                <div class="col-sm-4 col-xs-6 col-sm-push-6 g-hor-centered-row__col">
